...
describe('build_filter', () => {
  ...
  describe('basic filter without filter_fun', () => {
    it('should build filter with imports and no temp file on non-Windows', () => {
      ...
      const expected_filter = `import "args" as args; import "bash" as bash; import "github/gfm" as gfm; import "github/github" as github; import "str" as str; import "utils" as utils; import "validate" as validate; ${filter}`
  ...
  describe('filter with filter_fun', () => {
    it('should create temp dir for filter_fun and import it', () => {
      ...
      const expected_filter = `import "fun" as fun; import "args" as args; import "bash" as bash; import "github/gfm" as gfm; import "github/github" as github; import "str" as str; import "utils" as utils; import "validate" as validate; ${filter}`
      expect(result.filter_arg).toBe(`'${expected_filter}'`)
    })
  ...
  describe('filter imports', () => {
    it('should include all standard imports', () => {
      ...
      expect(result.filter_arg).toContain('import "github/github" as github')
