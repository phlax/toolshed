...
export function build_filter(
  ...
  mangled_filter = `import "args" as args; import "bash" as bash; import "github/gfm" as gfm; import "github/github" as github; import "str" as str; import "utils" as utils; import "validate" as validate; ${mangled_filter}`
